...
var getPublicationMultiplier = (tau) => tau.pow(2.324) * BigNumber.FIVE;
var getPublicationMultiplierFormula = (symbol) => "5" + symbol + "^{1.324}";
var getTau = () => currency.value.pow(2.142);
var getCurrencyFromTau = (tau) => [tau.max(BigNumber.ONE).pow(1 / 2.142), currency.symbol];
